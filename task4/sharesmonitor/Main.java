...
public class Main {
    public static void main(String[] args) {
        ...
        Stock amazon = new Stock("AMAZON", 3400.0);
        ...
        stockMarket.updateStockPrice("APPLE", 155.0);
        System.out.println("-----------------------------------");
        stockMarket.updateStockPrice("GOOGL", 2820.0);
        System.out.println("-----------------------------------");
        stockMarket.updateStockPrice("AMAZON", 3380.0);
        System.out.println("-----------------------------------");

        investor1.unsubscribe(apple);

        stockMarket.updateStockPrice("APPLE", 160.0);
    }
}
